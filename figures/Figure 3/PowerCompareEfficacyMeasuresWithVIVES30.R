...
p4=(ggplot(dfE,aes(x=Herds,y=power,col=measure,linetype=VE)) + geom_line()  +  scale_x_continuous('Herds',limits=c(50,300)) + scale_y_continuous('Efficacy',limits=c(-0.2,1)))

p3=(ggplot(df,aes(x=Herds,y=power,col=measure,linetype=VE)) + geom_line()  +  scale_x_continuous('Herds',limits=c(50,300)) + scale_y_continuous('Power'))
