...
casesW <- (VES90VEI0IVP100DIVA1df$Reactors > 0 | VES90VEI0IVP100DIVA1df$Slaughter > 0)  
casesM <- (VES90VEI0IVP50DIVA1df$Reactors > 0 | VES90VEI0IVP50DIVA1df$Slaughter > 0)
...
control <- (ICDIVA1df$Reactors > 0 | ICDIVA1df$Slaughter > 0)
casesW <- (VES90VEI30IVP100DIVA1df$Reactors > 0 | VES90VEI30IVP100DIVA1df$Slaughter > 0)  
casesM <- (VES90VEI30IVP50DIVA1df$Reactors > 0 | VES90VEI30IVP50DIVA1df$Slaughter > 0)
...
control <- (ICDIVA1df$Reactors > 0 | ICDIVA1df$Slaughter > 0)
casesW <- (VES90VEI60IVP100DIVA1df$Reactors > 0 | VES90VEI60IVP100DIVA1df$Slaughter > 0)  
casesM <- (VES90VEI60IVP50DIVA1df$Reactors > 0 | VES90VEI60IVP50DIVA1df$Slaughter > 0)
...
control <- (ICDIVA1df$Reactors > 0 | ICDIVA1df$Slaughter > 0)
casesW <- (VES90VEI90IVP100DIVA1df$Reactors > 0 | VES90VEI90IVP100DIVA1df$Slaughter > 0)  
casesM <- (VES90VEI90IVP50DIVA1df$Reactors > 0 | VES90VEI90IVP50DIVA1df$Slaughter > 0)
...
pdf('VES90PowerIncidencebyVI.pdf',height=2.5,width=6.5,family='Helvetica',pointsize=12)
grid.newpage()
