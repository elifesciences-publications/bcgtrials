...
casesW <- VES90VEI0IVP100DIVA1df$Break_Recurr[VES90VEI0IVP100DIVA1df$Breaklength>0]
casesM <- VES90VEI0IVP50DIVA1df$Break_Recurr[VES90VEI0IVP50DIVA1df$Breaklength>0]
...
control <- ICDIVA1df$Break_Recurr[ICDIVA1df$Breaklength>0]
casesW <- VES90VEI30IVP100DIVA1df$Break_Recurr[VES90VEI30IVP100DIVA1df$Breaklength>0]
casesM <- VES90VEI30IVP50DIVA1df$Break_Recurr[VES90VEI30IVP50DIVA1df$Breaklength>0]
...
control <- ICDIVA1df$Break_Recurr[ICDIVA1df$Breaklength>0]
casesW <- VES90VEI60IVP100DIVA1df$Break_Recurr[VES90VEI60IVP100DIVA1df$Breaklength>0]
casesM <- VES90VEI60IVP50DIVA1df$Break_Recurr[VES90VEI60IVP50DIVA1df$Breaklength>0]
...
control <- ICDIVA1df$Break_Recurr[ICDIVA1df$Breaklength>0]
casesW <- VES90VEI90IVP100DIVA1df$Break_Recurr[VES90VEI90IVP100DIVA1df$Breaklength>0]
casesM <- VES90VEI90IVP50DIVA1df$Break_Recurr[VES90VEI90IVP50DIVA1df$Breaklength>0]
...
p6=(ggplot(df,aes(x=Herds,y=100*median,ymin=100*lower,ymax=100*upper,linetype=VEI,col=coverage)) + geom_line()  +  scale_x_continuous('Herds') + scale_y_continuous('% Effect Size',limits=c(0,15)))+ guides(linetype = guide_legend(order=1,title=expression(epsilon[I])),colour=guide_legend(order=2,title='Coverage'))

pdf('VES90PowerRecurrencebyVI.pdf',height=2.5,width=6.5,family='Helvetica',pointsize=12)
grid.newpage()
