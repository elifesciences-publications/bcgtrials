...
pdf('Figure-Recurrence-Power-SOR.pdf',height=2.5*4,width=8.5,family='Helvetica',pointsize=12)
print(power_plot)
dev.off()

pdf('Figure-Recurrence-Effect-SOR.pdf',height=2.5*2,width=2.5*2,family='Helvetica',pointsize=12)
