...
ResidenceTime<-1/scan('../../../data/DarthTurnover.csv')
...
single_runSORITS <- function(vacc_target,retain_reactors,vacc_effS,vacc_effI,DIVA,herd_no,Immunity=1.0/1.650)
{
trial_duration = 50
batch_interval = 180
...
baseline<-single_runSORITS(0.0,1,0.0,0.0,DIVA1,3260-1)
treatment<-single_runSORITS(0.5,1,1.0,1.0,DIVA1,3260-1, 2.0)
