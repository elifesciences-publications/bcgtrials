...
1.0-vacc_effS,1.0,1,
10^params[5],10^params[12],1.0/1.650,1.0,10^params[5],10^params[5],10^params[12],
0.0,0.0,10^params[6],0.0,0.0,0.0,(1.0-vacc_effI)*(10^params[6]),10^params[7],
...
save.image('VEISweepSORIP.RData')
